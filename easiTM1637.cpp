...
uint8_t TM1637::tmCharTable[] = {0x3f, 0x06, 0x5b, 0x4f, 0x66, 0x6d, 0x7d, 0x07, 0x7f, 0x6f, // Numbers : 0-9.
...
void TM1637::begin(uint8_t numDigits, uint8_t brightness) {
  ...
  #endif
  if(numDigits > 0 && numDigits <= MAX_DIGITS) {          // The TM1637 supports between 1 and 6 digits.
...
void TM1637::displayBrightness(uint8_t brightness) {
  ...
  cmdDispCtrl = 0x88 + _brightness;                       // 88 + 0 to 7 brightness, 88 = display ON.
